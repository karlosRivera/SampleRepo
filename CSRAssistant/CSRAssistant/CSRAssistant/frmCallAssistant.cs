    ...
    public partial class frmCallAssistant : MetroFramework.Forms.MetroForm
    {
        ...
        private void MergeFiles()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    storefilelocation = config.AppSettings.Settings["localVoiceRecordsPath"].Value.Replace(",", "") + "\\";
                    wavfilename = txtPhNo.Text + "_" + datetime ;
                }
                ...
                MessageBox.Show(storefilelocation);
                MessageBox.Show(Utils.RootDir);
                ...
                try
                {
                    ...
                    //    if (File.Exists(Environment.CurrentDirectory + @"\Sox\Sox.exe"))
                    //    {
                    ...
                    //    if (File.Exists(Environment.CurrentDirectory + @"\Lame\Lame.exe"))
                    //    {
