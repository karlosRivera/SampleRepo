...
namespace DGVirtualScroll1
{
    public partial class SPCaller : Form
    {
        public SPCaller()
        {
            InitializeComponent();
    ...
    public class DataRetriever : IDataPageRetriever
    {
        ...
        public DataTable SupplyPageOfData(int lowerPageBoundary, int rowsPerPage)
        {
            ...
            command.Parameters.AddWithValue("@StartIndex", lowerPageBoundary);
            command.Parameters.AddWithValue("@EndIndex", rowsPerPage);
            adapter.SelectCommand = command;
            ...
            table = ds.Tables[1];
            columnsValue = table.Columns;
            rowCountValue = Convert.ToInt32(ds.Tables[0].Rows[0][0].ToString());
            return table;
        }
